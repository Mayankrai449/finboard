    ...
    <nav className="bg-[#1a1a2e] border-b border-[#333] px-8 py-4">
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          className="cursor-pointer flex items-center gap-2 px-4 py-2 bg-[#00d4ff]/10 hover:bg-[#00d4ff]/20 text-[#00d4ff] rounded-lg border border-[#00d4ff]/30 transition-all hover:scale-105 active:scale-95"
        >
